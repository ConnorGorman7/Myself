...
/* ────────────────────────────────────────────────────────────────────────
   ...
   Swap the .photo-slot blocks for real imagery when available.
   ──────────────────────────────────────────────────────────────────────── */
...
const SERVICES = [
  ...
  {
    name: "Pedicures",
    desc: "Relaxing spa pedicures — soak, scrub, and polish, start to finish.",
    price: "from $40",
  },
  {
    name: "Gel & Acrylic",
  ...
  {
    name: "Waxing",
    desc: "Gentle facial and body waxing — brows, lip, arms, legs, and more.",
    price: "from $12",
  },
  {
    name: "Add-ons",
...
export function MpNailsDemo() {
  ...
  return (
    <div className="min-h-screen bg-[#fbf7f4] font-sans text-[#3a3033] [font-family:var(--font-geist-sans)]">
      {/* Demo notice */}
      <div className="bg-[#3a3033] px-4 py-2 text-center font-sans text-xs tracking-wide text-[#f3e7e3]">
        Design preview · placeholder content for demonstration
      </div>
          ...
          <div className="mx-auto max-w-6xl px-5 py-16 md:py-20">
            <div className="max-w-xl">
              ...
              <p className="mt-3 font-sans text-[15px] leading-relaxed text-[#6b5f62]">
                A little something for every occasion. Prices are sample
                placeholders — final menu to be confirmed.
              </p>
            </div>
              ...
              {SERVICES.map((s) => (
                ...
                >
                  <div className="flex items-baseline justify-between gap-3">
                    ...
                    <span className="whitespace-nowrap font-sans text-sm font-medium text-[#b76e79]">
                      {s.price}
                    </span>
                  </div>
            ...
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                ...
                <p className="mt-3 max-w-md font-sans text-[15px] leading-relaxed text-[#6b5f62]">
                  A few placeholder spots — drop in real photos of your favorite
                  sets and designs.
                </p>
              </div>
              <a
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-5 py-16 md:grid-cols-2 md:py-20">
            ...
            {submitted ? (
              ...
              >
                ...
                <button
                  type="submit"
                  className="mt-6 w-full rounded-full bg-[#b76e79] px-6 py-3 font-sans text-sm font-medium text-white shadow-sm transition-colors hover:bg-[#9a5560]"
                >
                  Request appointment
                </button>
